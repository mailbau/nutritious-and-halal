    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setError(data.message || 'Gagal membuat data makanan')
            }
        } catch (err) {
            setError('Terjadi kesalahan saat membuat data makanan')
        } finally {
            setLoading(false)
        }
    }
        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-xl text-gray-900">Tambah Makanan Baru</span>
                        </div>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="space-y-6">
                    {/* Header */}
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Tambah Makanan Baru</h1>
                        <p className="text-gray-600 mt-1">Tambah data makanan baru ke database halal</p>
                    </div>
